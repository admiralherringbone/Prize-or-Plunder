/**
 * Represents a complete Brigantine Rig assembly.
...
class BrigantineRig {
    ...
    getDurabilityContribution() {
        ...
        const sailLength = this.ship.shipLength / 2;
     ...
     * The brigantine has a gaff sail on its mainmast.
    ...
    _drawFullGaffSailAssembly(ctx, zoomLevel, mastConfig, windDirection) {
        // For a brigantine, the mainmast gaff sail is a fixed proportion of the ship length.
        const sailLength = this.ship.shipLength / 2;
